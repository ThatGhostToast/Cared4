...
/**
 * Login form component to allow the user to sign in (displays the email failure error)
 * @returns Returns the login form with errors
 */
const LoginFormEmailFail = () => {
  ...
  //Return the login form with errors
  return (
    <div className="container is-max-desktop">
      ...
      <form onSubmit={handleFormSubmit}>
        <section className="section">
          <p class="help is-danger">Email not found</p>
          <div className="field">
...
export default LoginFormEmailFail;